        ...
        public void EnsureSeedData()
        {
            if (!_context.Trips.Any())
            {
                ...
                var usTrip = new Trip()
                {
                    ...
                    Stops = new List<Stop>()
                    {
                        new Stop() { Name="Atlanta, GA", Arrival = new DateTime(2014, 6, 4), Latitude = 33.768995, Longitude = 84.387982, Order = 0 },
                        ...
                        new Stop() { Name="Seattle, WA", Arrival = new DateTime(2014, 8, 13), Latitude = 67.606209, Longitude = 122.332071, Order = 4 },
